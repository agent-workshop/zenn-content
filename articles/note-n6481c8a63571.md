...
- **[AIエージェント開発テンプレート集（¥2,980）](https://agent-workshop.booth.pm/items/8070495)** — この記事で紹介した対策をすぐに導入できるテンプレート集。レートリミッター・ヘルスチェック・自動レビューなど。
- **[5つの地雷の詳細版（¥300）](https://agent-workshop.booth.pm/items/8074156)** — 本記事の内容をさらに深掘りした対策コード付き版。
