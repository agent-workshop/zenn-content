...
- **[AIエージェント開発テンプレート集（¥2,980）](https://agent-workshop.booth.pm/items/8070495)** — 本記事で触れたレートリミッター・自動レビュー・ヘルスチェックをTypeScript + Bunでそのまま使えるテンプレート集。
- **[AIエージェント開発で踏んだ5つの地雷（¥300）](https://agent-workshop.booth.pm/items/8074156)** — 無限ループ、褒め合い、コンテキスト溢れ…実際に本番で踏んだ地雷と対策コード付き。
